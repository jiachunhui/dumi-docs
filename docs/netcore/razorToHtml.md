...
```
具体使用说明看介绍 [RazorToHtmlClassLibrary ](https://www.nuget.org/packages/RazorToHtmlClassLibrary/)

## Attribute 自动生成静态页面

> 对静态化理解一直不是很清楚，大概的思路是没有问题，但就是代码上，不知道怎么下手，还是基础不好，偶然看到一位网友的方案 [StaticPage](https://github.com/toolgood/StaticPage) 

<Alert type="info">
  代码我在Razor Pages 项目中测试了，没有问题。 <br>
  一般我都是在Razor Pages下去切页面，交付。
</Alert>

#### **代码如下**
```c#
//类文件名：HtmlStaticFileAttribute.cs
